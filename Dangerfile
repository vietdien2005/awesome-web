message "Hi @#{github.pr_author} thank you for your submission. Be sure that you haven't got any errors below this. For any questions, ping @vietdien2005"

# Check for changes to README.md
hasReadmeChanges = git.modified_files.include?("README.md")
canMerge = github.pr_json["mergeable"]
warn("This PR cannot be merged yet.", sticky: false) unless canMerge
